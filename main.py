# "People-Min-Max-Detection - old rdx; 0.0.4 media-server; 1.0.0 person-detection"
...
def load_configuration_settings(source_id, source_name, **kwargs):
    global sources_list, polygons, loaded_camera_ids, allowed_People, max_time_threshold
    try:
